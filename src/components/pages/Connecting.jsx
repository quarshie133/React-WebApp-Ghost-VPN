...
import SwitchButtonYellow from "../assets/switchbutton-yellow.svg";
import Trophy from "../assets/trophyrectangle.svg";

function Connecting({ title, subtitle, kilpersec, megpersec }) {
  return (
    <div className="third-layer">
      <div className="fourth-layer">
        ...
        <h1>{title}</h1>
        <h3 className="subtitle-connecting">{subtitle}</h3>
